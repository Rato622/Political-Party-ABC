...
public class AddMemberServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            client.create_XML(memberXML);
            addMember(memberXML);
            RequestDispatcher disp = request.getRequestDispatcher("add_member_outcome.jsp");
    ...
    private void addMember(java.lang.String memberXML) throws ExceptionException, Exception_Exception {
        // Note that the injected javax.xml.ws.Service reference as well as port objects are not thread safe.
        // If the calling of port operations may lead to race condition some synchronization is required.
        za.gov.party.jws.PartyRESTService port = service.getPartyRESTServicePort();
        port.addMember(memberXML);
    }
