<%-- 
    Document   : edit_member_outcome
    Created on : Jun 19, 2018, 10:04:01 PM
    Author     : Lerato
--%>
...
<html>
    ...
    <body>
        <h1>Edit Member Outcome Details :</h1>
        <form action="UpdateMemberServlet.do" method="POST">
            <%
            ...
            <table>
               ...
               <tr>
                ...
                <tr>
                    <td></td>
                    <td><input type="submit" name="update" value="Update Member"></td>
                </tr>
            </table>
        </form>
    </body>
